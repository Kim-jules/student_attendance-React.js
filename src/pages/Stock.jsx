    ...
    <div>
      ...
      <div className="flex flex-col gap-6 my-10">
        <div className="div flex justify-between">
          ...
          <button onClick={handleVisibility} className=" right-[36%] top-[34%] bg-lime-400 text-slate-900 font-extrabold p-4 font-jetBrains rounded-xl flex items-center gap-2"><IoAdd className="text-2xl text-slate-900" />Add Product</button>
        </div>
        <TableIn visible={isVisible} />
      </div>
    </div>
        </div>
        <Footter />
